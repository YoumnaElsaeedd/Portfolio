    ...
    <div className='grid md:grid-cols-2 place-items-center gap-8'>
      ...
      >
        <TypeAnimation
          ...
          speed={50}
          repeat={Infinity}
          className="font-bold text-gray-400 text-xl md:text-5xl italic mb-6" // زيادة المسافة السفلية
        />
        <motion.p
          initial={{ opacity: 0 }}
          ...
          className="text-gray-200 md:text-7xl text-5xl tracking-tight mb-6" // زيادة المسافة السفلية
        >
          Hey, I am <br />
